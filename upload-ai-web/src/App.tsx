...
export function App() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-6 flex gap-3">
        ...
        <ScrollArea className="w-96 space-y-6 pb-5 " style={{
          maxHeight: "calc(100vh - 150px)"
        }}>
          <form className="space-y-6 px-1">
            <label 
              htmlFor="video"
              className="border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-white/5"
            >
              <FileVideo />
              Selecione um vídeo
            </label>
          ...
          <form className="space-y-6 px-1">
            ...
            <div className="space-y-4">
              ...
              <span className="block text-xs text-muted-foreground italic leading-relaxed">
                Valores mais altos tendem a deixar o resultado mais criativo, porem, com maior chance de erros.
              </span>
            </div>
